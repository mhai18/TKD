<nav class="iq-sidebar-menu">
    <ul id="iq-sidebar-toggle" class="side-menu">
        ...
        <li class="sidebar-layout @yield(section: 'player')">
            <a href="{{ route('chairmanPlayer') }}" class="svg-icon">
                <i class="">
        ...
        <li class="sidebar-layout @yield(section: 'chapter')">
            <a href="{{ route('chairmanChapter') }}" class="svg-icon">
                <i class="">
                    <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-layout @yield(section: 'kyorugi')">
            <a href="{{ route('chairmanKyorugi') }}" class="svg-icon">
                <i class="">
                    <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-layout @yield(section: 'kyorugiPlayer')">
            <a href="{{ route('chairmanKyorugiTournament') }}" class="svg-icon">
                <i class="">
                    <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li class="sidebar-layout @yield(section: 'kyorugiMatches')">
            <a href="{{ route('chairmanKyorugiMatches') }}" class="svg-icon">
                <i class="">
                    <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
