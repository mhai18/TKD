<nav class="iq-sidebar-menu">
    <ul id="iq-sidebar-toggle" class="side-menu">
        ...
        <li class="sidebar-layout @yield(section: 'chapter')">
            <a href="{{ route('playerChapter') }}" class="svg-icon">
                <i class="">
        ...
        <li class="sidebar-layout @yield(section: 'schedule')">
            <a href="{{ route('playerViewSchedule') }}" class="svg-icon">
                <i class="">
                    <svg class="svg-icon" id="iq-user-1-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                </i><span class="ml-2">Match Schedule</span>
            </a>
        </li>
    </ul>
</nav>
